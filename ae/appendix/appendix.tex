...
\code{make bench-table3-real} & 22.9\,/\,28.4~GB/s reference on
c6a.48xlarge \\
\bottomrule
\multicolumn{3}{@{}l@{}}{\footnotesize Throughput variants:
\code{bench-table3} $\cdot$ \code{bench-baselines} (ZipNN, OpenZL,
official BitX).} \\
\end{tabular}
\end{center}
